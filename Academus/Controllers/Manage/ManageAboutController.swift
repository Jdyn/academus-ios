...
extension ManageAboutController {
    ...
    private func aboutCell(c: AboutCellManager, cell: UITableViewCell) -> UITableViewCell {
        ...
        let title = UILabel().setUpLabel(text: c.getTitle(), font: UIFont.subheader!, fontColor: .navigationsGreen)
        ...
        icon.anchors(right: background.rightAnchor, rightPad: -3, centerY: title.centerYAnchor, width: 18, height: 18)
    ...
    private func headerView() -> UIView {
        ...
        let versionLabel = UILabel().setUpLabel(text: "Version: 1.0.1 (1)", font: UIFont.subtext!, fontColor: .navigationsLightGrey)
