...
extension ManageIntegrationsController {
    ...
    private func integrationCell(cell: UITableViewCell, integration: UserIntegrations) -> UITableViewCell {
        ...
        circle.anchors(left: background.leftAnchor, leftPad: 9, centerY: background.centerYAnchor, width: 14, height: 14)
        icon.anchors(left: circle.rightAnchor, leftPad: 9, centerY: background.centerYAnchor , width: 36, height: 36)
        name.anchors(bottom: icon.centerYAnchor ,left: icon.rightAnchor, leftPad: 9)
        date.anchors(top: icon.centerYAnchor, topPad: 0, left: icon.rightAnchor, leftPad: 9)
        syncIcon.anchors(right: background.rightAnchor, rightPad: -16, centerY: background.centerYAnchor, width: 32, height: 32)
        return cell
    }
