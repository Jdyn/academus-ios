...
//    let betaCodeField: UITextField = UITextField()
//    let firstNameField: UITextField = UITextField()
//    let lastNameField: UITextField = UITextField()
//    let emailField: UITextField = UITextField()
//    let passwordField: UITextField = UITextField()
//    let verifyPasswordField: UITextField = UITextField()
//    let logInButton: UIButton = UIButton(type: .system)
    
//    let welcomeText: UILabel = {
//        let label = UILabel()
//        label.setUpLabel(text: "Let's get a few things straight.", font: UIFont.UIHeader!, fontColor: .navigationsWhite)
...
//    setupElements() {
//
//    emailField.setupTextField(isBottomBorder: true, isGhostText: true, ghostText: "Email", isLeftImage: false)
//
//    }
//    
